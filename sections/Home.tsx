...
const Home = () => {
  return (
    <div className="h-[88vh] bg-[url('/images/banner.jpg')] bg-cover bg-center flex items-center justify-center">
      <div className=" relative mt-[8rem]  flex flex-col items-center justify-center bg-[#300754] rounded-3xl md:px-12 pt-[8rem] md:pt-[7rem] px-6 pb-6">
        <img
          src="/images/profile.png"
          className="absolute bottom-[10rem] md:bottom-[12rem] rounded-full h-[250px] sm:w-[250px]  border-4 border-[#DB00FF]"
        />
